...
use crate::metamodel::concerto_metamodel_1_0_0::{Model, ImportKind, Declaration, Property};
...
impl ModelFile {
    ...
    pub fn get_imports(&self) -> Vec<&ImportKind> {
    ...
    pub fn add_import(&mut self, import: ImportKind) {
