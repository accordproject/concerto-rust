...
| `ModelManager`: `metamodel_validation`, `set_metamodel_validation`, `validate_ast` | 3 | Stable | P4-08b: TS `options.metamodelValidation` and `BaseModelManager.validateAst`. The option becomes a builder option (5.2). |
